...
function ProductPage() {
    return (
        <>
            ...
            <h5 className='text-center mt-5 mb-5'>Want to know more about our technology stack? Check out the <a href='' style={{textDecoration:"none"}}>Finverse.tech</a> blog.</h5>
            <Universe />
