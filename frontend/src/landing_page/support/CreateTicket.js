        ...
        <div className="container">
            <div className='row p-5 mt-5'>
                ...
                <div className='col-4 p-5 mt-5'>
                    ...
                    <a href=''style={{textDecoration:"none",lineHeight:"2.5"}}>Charges at Finverse</a><br/>
                    <a href=''style={{textDecoration:"none",lineHeight:"2.5"}}>Finverse IDFC First Bank 3-in-1 Account</a><br/>
                    <a href=''style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a>
                </div>
                <div className='col-4 p-5 mt-5'>
                    <h4 className='fs-4 text-muted'>
                        <i class="fa fa-user" aria-hidden="true"></i> Your Finverse Account
                    </h4>
                ...
                <div className='col-4 p-5 mt-5 '>
                    <h4 className='fs-4 text-muted'>
                        <i class="fa fa-bar-chart" aria-hidden="true"></i> Your Finverse Account
                    </h4>
